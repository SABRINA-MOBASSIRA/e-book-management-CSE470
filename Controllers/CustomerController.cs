...
namespace EBM.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,Name,PhoneNumber,Address,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,Name,PhoneNumber,Address,Email")] Customer customer)
        {
            if (ModelState.IsValid)
            {
