...
namespace EBM.Controllers
{
    public class SellerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SellerID,Name,PhoneNumber,Email")] Seller seller)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SellerID,Name,PhoneNumber,Email")] Seller seller)
        {
            if (ModelState.IsValid)
            {
