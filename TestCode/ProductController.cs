...
namespace EBM.Controllers
{
    ...
    {
        //private readonly interfaceEMBRepository _dbRepository;
        ...
        //    db = dbContext;
        //}
        //public ProductController(interfaceEMBRepository dbRepository)
        //{
        ...
        public ActionResult Details(int? id)
        {
            ...
            //Product product = _dbRepository.GetProduct(id);
            if (product == null)
            {
                return HttpNotFound();
            }
